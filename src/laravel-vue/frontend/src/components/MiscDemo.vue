<template>
    ...
    <div class="p-col-12 p-lg-6">
        ...
        <div class="card">
            ...
            <h5>Styling</h5>
            <div class="p-d-flex p-ai-center p-flex-column p-flex-sm-row">
                <Chip label="Action" class="p-mr-2 custom-chip p-mb-2"></Chip>
                <Chip label="Comedy" class="p-mr-2 custom-chip p-mb-2"></Chip>
                <Chip label="Onyama Limba" image="assets/demo/images/avatar/onyamalimba.png" class="p-mr-2 custom-chip p-mb-2"></Chip>
                <Chip label="Xuxue Feng" image="assets/demo/images/avatar/xuxuefeng.png" :removable="true" class="custom-chip p-mb-2"></Chip>
            </div>
        </div>
...
<style lang="scss" scoped>
    :v-deep(.misc-demo .p-button.p-widget) {
        min-width: 6rem;
	}

    ::v-deep(.misc-demo .badges .p-badge) {
        margin-right: .5rem;
    }

	::v-deep(.misc-demo .badges .p-tag) {
		margin-right: .5rem;
	}
