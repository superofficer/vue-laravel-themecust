...
export default {
	...
	methods: {
		...
		saveProduct() {
			...
			if (this.product.name.trim()) {
				if (this.product.id) {
					...
					axios.patch(`http://localhost:8000/api/products/${this.product.id}`, this.product);
					...
					axios.post('http://localhost:8000/api/products', this.product).then((res) => console.log(res))
		...
		deleteSelectedProducts() {
			...
			for ( const productDetail of this.selectedProducts ) {
				console.log(productDetail.id)
				axios.delete(`http://localhost:8000/api/products/${productDetail.id}`);
			}
