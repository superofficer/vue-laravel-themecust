<template>
	<div :class="layoutContainerClass" @click="onDocumentClick">
		<AppTopBar v-show="tokenInfo" :horizontal="menuMode==='horizontal'" :topbarMenuActive="topbarMenuActive" :activeTopbarItem="activeTopbarItem" :mobileTopbarActive="mobileTopbarActive" @topbar-mobileactive="onTopbarMobileButtonClick"
			...
			<div v-show="tokenInfo" class="menu-wrapper">
		...
		<div :class="tokenInfo ? 'layout-main': ''">
			<div v-show="tokenInfo">
				<AppBreadcrumb></AppBreadcrumb>
			</div>
			<div v-show="tokenInfo" class="layout-content">
				<router-view />
			</div>
			<div v-show="!tokenInfo">
				<Login />
