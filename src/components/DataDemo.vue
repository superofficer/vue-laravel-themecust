			...
			<div class="card">
				...
				<TreeTable :value="ttNodes" selectionMode="checkbox" :selectionKeys.sync="selectedTTNodes">
                    ...
                    <Column headerStyle="width: 8em; text-align: center" bodyStyle="text-align: center">
                        <template #header>
                            <Button type="button" icon="pi pi-md-settings"></Button>
                        </template>
                        <template #body="slotProps">
                            <Button type="button" icon="pi pi-md-search" class="p-button-success" style="margin-right: .5em"></Button>
                            <Button type="button" icon="pi pi-md-edit" class="p-button-warning"></Button>
                        </template>
                    </Column>
                    <template #footer>
                        <div style="text-align:left">
                            <Button icon="pi pi-md-refresh" class="p-button-success" />
                        </div>
                    </template>
                </TreeTable>
			</div>
