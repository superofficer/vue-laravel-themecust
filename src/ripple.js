	...
	init: function () {
		...
		document.addEventListener("mousedown", function (e) {
			for (var target = e.target; target && target !== this; target = target.parentNode) {
				...
				if ($this.selectorMatches(target, '.ripplelink, .p-button, .p-listbox-item, .p-multi-selectitem, .p-fieldset-toggler')) {
					var element = target;
...
document.addEventListener("DOMContentLoaded", SapphireRipple.init());